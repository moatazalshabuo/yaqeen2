    ...
    @section('content')
        ...
        <div class="modal" id="salesbill-model"  data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title" id="product-name">اضافة منتج للفاتورة</h6><button aria-label="Close" class="close close-modal" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="from-group">
                                                ...
                                                <input type="text" class="form-control" name="descripe" placeholder="تفاصيل المنتج">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="from-group">
                                                <label>العدد</label>
                                                <input type="number" class="form-control count-totel" id="count" name="count" value="1" placeholder="عدد الطلب">
                                            </div>
                                        </div>
                                    </div>
					...
					<div class="modal-footer">
						...
						<button class="btn ripple btn-secondary close-modal" data-dismiss="modal" type="button">اغلاق</button>
					</div>
				</div>
			</div>
		</div>
